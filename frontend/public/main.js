...
const prescriptionDatabase = [
  {
    ...
    date: "2025-04-10",
    medicines: [
      { code: "MED001", dosage: "1 viên x 3 lần/ngày", duration: "5 ngày" },
      { code: "MED003", dosage: "1 viên x 1 lần/ngày", duration: "7 ngày" },
    ],
    status: "Đã phê duyệt",
  },
  {
    ...
    patientId: 502,
    date: "2025-04-12",
    medicines: [{ code: "MED002", dosage: "1 viên x 2 lần/ngày", duration: "7 ngày" }],
    status: "Đã phê duyệt",
  },
]
...
const orderDatabase = [
  {
    ...
    status: "Đã xử lý",
    items: [
      { code: "MED001", quantity: 15 },
      { code: "MED003", quantity: 7 },
    ],
  },
  {
    id: "ORD002",
